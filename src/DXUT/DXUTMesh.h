...
//--------------------------------------------------------------------------------------
struct NV_DXUT_API SDKMESH_HEADER
{
...
struct NV_DXUT_API SDKMESH_VERTEX_BUFFER_HEADER
{
    UINT64 NumVertices;
    UINT64 SizeBytes;
    UINT64 StrideBytes;
...
struct NV_DXUT_API SDKMESH_INDEX_BUFFER_HEADER
{
    UINT64 NumIndices;
    UINT64 SizeBytes;
    UINT IndexType;
...
struct NV_DXUT_API SDKMESH_MESH
{
...
struct NV_DXUT_API SDKMESH_SUBSET
{
...
struct NV_DXUT_API SDKMESH_FRAME
{
...
struct NV_DXUT_API SDKMESH_MATERIAL
{
...
struct NV_DXUT_API SDKANIMATION_FILE_HEADER
{
    UINT Version;
    BYTE IsBigEndian;
...
struct NV_DXUT_API SDKANIMATION_DATA
{
...
struct NV_DXUT_API SDKANIMATION_FRAME_DATA
{
...
struct NV_DXUT_API SDKMESH_CALLBACKS9
{
...
typedef void ( CALLBACK*LPCREATEINDEXBUFFER10 )( ID3D10Device* pDev, ID3D10Buffer** ppBuffer,
                                                 D3D10_BUFFER_DESC BufferDesc, void* pData, void* pContext );
struct NV_DXUT_API SDKMESH_CALLBACKS10
{
...
//--------------------------------------------------------------------------------------
class NV_DXUT_API CDXUTSDKMesh
{
private:
...
//-----------------------------------------------------------------------------
class NV_DXUT_API CDXUTXFileMesh
{
public:
    WCHAR       m_strName[512];
