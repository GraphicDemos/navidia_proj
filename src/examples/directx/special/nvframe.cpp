...
HRESULT NVFrame::SetFVF(IDirect3DDevice9* pDevice, DWORD dwFVF)
{
...
HRESULT NVFrame::SetTexture(LPDIRECT3DBASETEXTURE9 pTexture)
{
...
HRESULT NVFrame::RestoreDeviceObjects( IDirect3DDevice9* pDevice )
{
...
HRESULT NVFrame::Render( IDirect3DDevice9* pDevice, BOOL bDrawOpaqueSubsets,
