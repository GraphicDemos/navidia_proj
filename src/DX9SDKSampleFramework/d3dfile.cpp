...
{
    NV_LPD3DXFILEDATA   pChildData = NULL;
    DWORD       cbSize;
...
#ifdef NV_USEDX90C
	OutputDebugString(L"NVIDIA DX9SDKSampleFramework CD3DFile::CreateFromResource() disabled for DX9.0c Summer 2004 update\n");
	return( E_FAIL );
...
//	ID3DXFileEnumObject *	pEnumObj;
//	ID3DXFileData *			pFileData;
	OutputDebugString(L"NVIDIA DX9SDKSampleFramework CD3DFile::Create() disabled for DX9.0c Summer 2004 update\n");
	return( E_FAIL );
#else
