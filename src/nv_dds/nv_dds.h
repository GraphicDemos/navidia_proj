...
#  ifdef NV_DDS_EXPORTS
#    define NV_DDS_API __declspec(dllexport)
#  else
#    define NV_DDS_API __declspec(dllimport)
#  endif
#endif
#else
#  define NV_DDS_API
...
namespace nv_dds
{
    ...
    struct NV_DDS_API DXT3AlphaBlock
    {
        unsigned short row[4];
    };

    struct  NV_DDS_API DXT5AlphaBlock
    {
    ...
    struct NV_DDS_API DDS_PIXELFORMAT
    {
    ...
    class NV_DDS_API CTexture : public CSurface
    {
