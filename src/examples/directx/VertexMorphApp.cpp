...
INT WINAPI WinMain( HINSTANCE, HINSTANCE, LPSTR, int )
{
    ...
    DXUTCreateWindow( L"Morphing Dolphin 1.0 (DX9) (HLSL)" );
...
void InitApp()
{
    ...
    g_HUD.AddButton( IDC_WIREFRAME, L"Wireframe (W)", 35, 82, 125, 22, L'W' );
}
...
{
    return SUCCEEDED(g_pVM->ConfirmDevice(pCaps, 0, AdapterFormat, BackBufferFormat));
}
                                ...
                                const D3DSURFACE_DESC* pBackBufferSurfaceDesc, void* pUserContext )
{
	...
	*/
	...
	V_RETURN(g_pVM->RestoreDeviceObjects( pd3dDevice ));
...
void CALLBACK OnGUIEvent( UINT nEvent, int nControlID, CDXUTControl* pControl, void* pUserContext )
{
	switch( nControlID )
    {
        ...
        case IDC_WIREFRAME:			g_pVM->ToggleWireframe(); break;
    }
}
