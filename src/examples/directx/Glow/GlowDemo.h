...
public:
	...
	std::vector< D3DXVECTOR4 >	m_vBlurHCoefficients;
	std::vector< D3DXVECTOR4 >	m_vBlurHCoords;
	std::vector< D3DXVECTOR4 >	m_vBlurVCoefficients;
	std::vector< D3DXVECTOR4 >	m_vBlurVCoords;

	D3DCOLOR				m_dwGlowTextureAttenuation;		// multiplied by glow texture when adding to backbuffer
