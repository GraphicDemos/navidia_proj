...
struct NV_DXUT_API DXUTCache_Texture
{
...
struct NV_DXUT_API DXUTCache_Font : public D3DXFONT_DESC
{
    ID3DXFont* pFont;
};

struct NV_DXUT_API DXUTCache_Effect
{
    DXUTCACHE_SOURCELOCATION Location;
    WCHAR wszSource[MAX_PATH];
    HMODULE hSrcModule;
...
class NV_DXUT_API CDXUTResourceCache
{
public:
                            ~CDXUTResourceCache();
...
//--------------------------------------------------------------------------------------
class NV_DXUT_API CDXUTTextHelper
{
public:
...
//--------------------------------------------------------------------------------------
NV_DXUT_API HRESULT WINAPI DXUTFindDXSDKMediaFileCch( __out_ecount(cchDest) WCHAR* strDestPath,
                                          __in int cchDest, 
