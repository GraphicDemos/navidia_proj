...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Include Guard
#ifndef __NVBSTRING_H__
#define __NVBSTRING_H__
...
#include "NVBTypes.h"
    ...
    class NVBCORE_API String
    {
        ...
        inline_         operator float()                                const   { float tmp = 3.402823466e+38F; IsFloat(&tmp); return tmp;         }
    ...
    NVBCORE_API inline_ bool operator==(const String& s1, const char* s2)   { return s1.Compare(s2) == 0; } //!< Operator for String == char*
    NVBCORE_API inline_ bool operator!=(const String& s1, const char* s2)   { return s1.Compare(s2) != 0; } //!< Operator for String != char*

    NVBCORE_API inline_ bool operator==(const String& s1, const String& s2) { return s1.Compare(s2) == 0; } //!< Operator for String == String
    NVBCORE_API inline_ bool operator!=(const String& s1, const String& s2) { return s1.Compare(s2) != 0; } //!< Operator for String != String
    NVBCORE_API inline_ bool operator< (const String& s1, const String& s2) { return s1.Compare(s2) <  0; } //!< Operator for String < String
    NVBCORE_API inline_ bool operator> (const String& s1, const String& s2) { return s1.Compare(s2) >  0; } //!< Operator for String > String
    NVBCORE_API inline_ bool operator<=(const String& s1, const String& s2) { return s1.Compare(s2) <= 0; } //!< Operator for String <= String
     ...
     */
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
     NVBCORE_API bool SortStrings(udword nb, void * slist, udword stride=0);

#endif // __NVBSTRING_H__
