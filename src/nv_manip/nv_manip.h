...
#define NV_MANIP_API DLL_EXPORT
#define NV_MANIP_CLASS DLL_EXPORT_CLASS
#else
#define NV_MANIP_API DLL_IMPORT
#define NV_MANIP_CLASS DLL_IMPORT
#endif
#else // NVMATH_SHARED
#define NV_MANIP_API
#define NV_MANIP_CLASS
#endif // NVMATH_SHARED
