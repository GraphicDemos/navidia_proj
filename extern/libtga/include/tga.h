...
struct _TGAHeader {
	...
	tbyte	map_entry;	/* F4.3: bit-depth of a cmap entry */ /*16 for targa 16,24 for the targa 24 ,32 for the targa 32*/
	//Image specification
	tshort	x;		/* F5.1: x-coordinate */
	tshort	y;		/* F5.2: y-coordinate */
	tshort	width;		/* F5.3: width of image */
	tshort	height;		/* F5.4: height of image */
	tbyte	depth;		/* F5.5: pixel-depth of image */ /*number of attribute bits associated with each pixel*/
