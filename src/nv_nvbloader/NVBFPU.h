...
*/
    ...
    enum FPUMode
    {
     ...
     NVBCORE_API FPUMode    GetFPUMode();
     NVBCORE_API void       SaveFPU();
     NVBCORE_API void       RestoreFPU();
     NVBCORE_API void       SetFPUFloorMode();
     NVBCORE_API void       SetFPUCeilMode();
     NVBCORE_API void       SetFPUBestMode();
