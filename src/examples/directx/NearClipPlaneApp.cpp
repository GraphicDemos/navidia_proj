...
INT WINAPI WinMain( HINSTANCE, HINSTANCE, LPSTR, int )
{
    ...
    DXUTCreateWindow( L"Near Clip Plane Using Projection Matrix (DX9)" );
...
void InitApp()
{
    g_pNearClipPlaneApp = new NearClipPlane;
    g_pNearClipPlaneApp->OneTimeSceneInit();
    ...
    g_HUD.AddButton( IDC_TOGGLERENDER, L"Render Clip Plane (M)", 35, 82, 125, 22 );
    g_HUD.AddButton( IDC_TOGGLEDIRECTION, L"Clip Plane Direction (D)", 35, 82, 125, 22 );
    g_HUD.AddButton( IDC_TOGGLEUSE, L"Clip Plane / Proj Matrix (X)", 35, 82, 125, 22 );
}
                                  ...
                                  D3DFORMAT BackBufferFormat, bool bWindowed, void* pUserContext )
{
    ...
    bCapsAcceptable = (g_pNearClipPlaneApp->ConfirmDevice(pCaps, 0, AdapterFormat, BackBufferFormat) == S_OK);
...
HRESULT CALLBACK OnCreateDevice( IDirect3DDevice9* pd3dDevice, const D3DSURFACE_DESC* pBackBufferSurfaceDesc, void* pUserContext )
{
    ...
    g_pNearClipPlaneApp->InitDeviceObjects(pd3dDevice);
                                ...
                                const D3DSURFACE_DESC* pBackBufferSurfaceDesc, void* pUserContext )
{
    ...
    g_pNearClipPlaneApp->RestoreDeviceObjects(pd3dDevice);
...
void CALLBACK OnFrameRender( IDirect3DDevice9* pd3dDevice, double fTime, float fElapsedTime, void* pUserContext )
{
    ...
    {
        // render world
        g_pNearClipPlaneApp->Render(pd3dDevice);
...
void RenderText()
{
	...
	else
	{
        ...
        txtHelper.DrawTextLine( L"Left mouse + drag: Rotate clip plane\n"
                                L"Middle mouse + drag: Scale clip plane\n"
                                L"Right mouse + drag: Pan clip plane\n"
                                L"M - Toggle rendering of clip plane\n"
                                L"D - Toggle direction of clip plane\n");

        txtHelper.SetInsertionPos( 250, pd3dsdBackBuffer->Height-15*5 );
        txtHelper.DrawTextLine( L"X - Toggle use of clip plane\n" );
...
LRESULT CALLBACK MsgProc( HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam, bool* pbNoFurtherProcessing, void* pUserContext )
{
    ...
    *pbNoFurtherProcessing = g_HUD.MsgProc( hWnd, uMsg, wParam, lParam );
    ...
    g_pNearClipPlaneApp->MsgProc( hWnd, uMsg, wParam, lParam );
...
void CALLBACK OnGUIEvent( UINT nEvent, int nControlID, CDXUTControl* pControl, void* pUserContext )
{
	switch( nControlID )
    {
        ...
        case IDC_TOGGLERENDER:     g_pNearClipPlaneApp->m_bRenderClipPlane ^= 1; break;
        case IDC_TOGGLEDIRECTION:  g_pNearClipPlaneApp->m_dir ^= 1; break;
        case IDC_TOGGLEUSE:        g_pNearClipPlaneApp->m_bUseClipPlanes ^= 1; break;
    }
}
...
void CALLBACK OnLostDevice( void* pUserContext )
{
    ...
    g_pNearClipPlaneApp->InvalidateDeviceObjects();
...
void CALLBACK OnDestroyDevice( void* pUserContext )
{
    ...
    g_pNearClipPlaneApp->DeleteDeviceObjects();
