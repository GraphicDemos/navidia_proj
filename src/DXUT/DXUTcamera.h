...
//--------------------------------------------------------------------------------------
class NV_DXUT_API CFirstPersonCamera : public CBaseCamera
{
public:
                    CFirstPersonCamera();
...
//--------------------------------------------------------------------------------------
class NV_DXUT_API CModelViewerCamera : public CBaseCamera
{
public:
                    CModelViewerCamera();
...
//--------------------------------------------------------------------------------------
class NV_DXUT_API CDXUTDirectionWidget
{
public:
