...
// Function linkage
#if DIRECT_SHOW_BASE_CLASS_DLL
#ifdef DIRECT_SHOW_BASE_CLASS_EXPOORT
#define DIRECT_SHOW_BASE_CLASS_API __declspec(dllexport)
#define DIRECT_SHOW_BASE_CLASS_CLASS __declspec(dllexport)
#else
#define DIRECT_SHOW_BASE_CLASS_API __declspec(dllimport)
#define DIRECT_SHOW_BASE_CLASS_CLASS __declspec(dllimport)
#endif
#else // DIRECT_SHOW_BASE_CLASS_DLL
#define DIRECT_SHOW_BASE_CLASS_API
#define DIRECT_SHOW_BASE_CLASS_CLASS
#endif // DIRECT_SHOW_BASE_CLASS_DLL
...
class DIRECT_SHOW_BASE_CLASS_CLASS CBaseObject
{
...
class AM_NOVTABLE DIRECT_SHOW_BASE_CLASS_CLASS CUnknown : public INonDelegatingUnknown,
                 public CBaseObject
{
private:
