...
class DIRECT_SHOW_BASE_CLASS_CLASS CBaseRenderer : public CBaseFilter
{
protected:
...
class DIRECT_SHOW_BASE_CLASS_CLASS CBaseVideoRenderer : public CBaseRenderer,    // Base renderer class
