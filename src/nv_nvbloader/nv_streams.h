...
class NVBCORE_API nv_input_stream
{
public:
    //
 ...
 *
 */
class NVBCORE_API nv_output_stream
{
public:
    //
    // Construction and destruction
 ...
 *
 */
class NVBCORE_API nv_input_output_stream: virtual public nv_input_stream, virtual public nv_output_stream
{
public:
    //
