...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Include Guard
#ifndef __NVBMEMORYMACROS_H__
#define __NVBMEMORYMACROS_H__
...
#endif
    #define SAFE_DESTRUCT(x)    if (x) { (x)->SelfDestruct();   (x) = null; }   //!< Safe NVB-style release

#ifdef __NVBERROR_H__
    #define CHECKALLOC(x)       if(!x) return SetNVBError("Out of memory.", EC_OUTOFMEMORY);    //!< Standard alloc checking. HANDLE WITH CARE.
#else
