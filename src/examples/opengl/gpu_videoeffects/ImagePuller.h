#ifndef IMAGE_PULLER_H
#define IMAGE_PULLER_H
// ----------------------------------------------------------------------------
// 
// Content:
//      ImagePuller class
...
// ImagePuller class
//
class ImagePuller: public ImageSink
{
public:
    //
    // Public data
...
public:
    ...
    //
            ...
            //
    ImagePuller(unsigned int nWidth = 0, unsigned int nHeight = 0);
