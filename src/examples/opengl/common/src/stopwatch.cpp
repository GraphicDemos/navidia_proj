...
// $Id: stopwatch.cpp,v 1.1.1.1 2003/01/27 20:52:10 harrism Exp $
//------------------------------------------------------------------------------
...
float StopwatchGeneric::diffTime() const
{
  ...
  return (float)(newStamp.tv_sec - lastStamp.tv_sec)
    + ((float)(newStamp.tv_usec - lastStamp.tv_usec))/1000.0f;
}
#endif
