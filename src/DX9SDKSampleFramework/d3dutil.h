...
#include "nv_dx9_sdk_sample_decl.h"
...
//-----------------------------------------------------------------------------
D3DXMATRIX NVDX9SDKSampleFramework_API D3DUtil_GetCubeMapViewMatrix( DWORD dwFace );
...
//       position.
//-----------------------------------------------------------------------------
D3DXQUATERNION NVDX9SDKSampleFramework_API D3DUtil_GetRotationFromCursor( HWND hWnd,
...
//-----------------------------------------------------------------------------
HRESULT NVDX9SDKSampleFramework_API D3DUtil_SetDeviceCursor( LPDIRECT3DDEVICE9 pd3dDevice, HCURSOR hCursor,
                                 BOOL bAddWatermark );
...
//-----------------------------------------------------------------------------
LPCTSTR NVDX9SDKSampleFramework_API D3DUtil_D3DFormatToString( D3DFORMAT format, bool bWithPrefix = true );
...
// Desc:
//-----------------------------------------------------------------------------
class NVDX9SDKSampleFramework_API CD3DArcBall
{
public:
    CD3DArcBall();
...
//       keeps common state.
//-----------------------------------------------------------------------------
class NVDX9SDKSampleFramework_API CBaseCamera
{
public:
    CBaseCamera();
...
//-----------------------------------------------------------------------------
class NVDX9SDKSampleFramework_API CFirstPersonCamera : public CBaseCamera
{
public:
    CFirstPersonCamera();
...
// Desc: 
//-----------------------------------------------------------------------------
class NVDX9SDKSampleFramework_API CModelViewerCamera : public CBaseCamera
{
public:
    CModelViewerCamera();
