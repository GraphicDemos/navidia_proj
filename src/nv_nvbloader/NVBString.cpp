 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool SortStrings(udword nb, void * slist, udword stride)
{
    // Checkings
    if(!nb || !slist)   return false;
    ...
    qsort( slist, nb, stride+sizeof(String*), Local::SortCB);
    return true;
}
...
sdword String::Compare(const String& str2) const
{
    ...
    return strcmp(mText, str2.mText);
}
...
String& String::ToUpper()
{
    if(mText)
    {
        for(udword i=0;i<Length();i++)  mText[i] = (char)toupper(mText[i]);
    }
    return *this;
}
...
String& String::ToLower()
{
    if(mText)
    {
        for(udword i=0;i<Length();i++)  mText[i] = (char)tolower(mText[i]);
    }
    return *this;
}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
 *  A method to replace a character with another.
 *  \param      oldchar     [in] character to find and replace
 *  \param      newchar     [in] new character
 *  \return     number of replaced characters
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
udword String::Replace(char oldchar, char newchar)
{
    if(!mText)  return 0;
    udword i=0;
    udword Count=0;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
 *  A method to get a parameter from a command line.
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
 *  A method to compute the number of parameters included in a string.
...
sdword String::Find(ubyte character, udword from, sdword to)
{
    ...
    return((pos == (udword) to + 1) || (pos == length) ? (udword)-1 : pos);
}
...
{
    udword  ret = sscanf((const char*) GetBuffer() + from, "%f", &f);
    return (ret ? true : false);
}

bool String::Extract(udword& i, udword from)
{
    udword  ret = sscanf((const char*) GetBuffer() + from, "%d", &i);
    return (ret ? true : false);
}
...
{
    return (strcmp((const char*) mCharBuf, (const char*) str.mCharBuf) == 0 ? true : false);
}
...
{
    return (strcmp((const char*) mCharBuf, (const char*) str) == 0 ? true : false);
}
...
bool String::operator!=(String& str)
{
    return (strcmp((const char*) mCharBuf, (const char*) str.mCharBuf) == 0 ? false : true);
}
...
bool String::operator!=(char* str)
{
    return (strcmp((const char*) mCharBuf, (const char*) str) == 0 ? false : true);
}
