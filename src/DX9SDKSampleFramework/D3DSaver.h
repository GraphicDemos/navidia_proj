...
enum NVDX9SDKSampleFramework_API SaverMode
{
...
//-----------------------------------------------------------------------------
struct NVDX9SDKSampleFramework_API D3DModeInfo
{
...
// Desc: Structure for holding information about a display mode
//-----------------------------------------------------------------------------
struct NVDX9SDKSampleFramework_API D3DWindowedModeInfo
{
...
//-----------------------------------------------------------------------------
struct NVDX9SDKSampleFramework_API D3DDeviceInfo
{
    // Device data
...
//-----------------------------------------------------------------------------
struct NVDX9SDKSampleFramework_API D3DAdapterInfo
{
    // Adapter data
...
//-----------------------------------------------------------------------------
struct NVDX9SDKSampleFramework_API MonitorInfo
{
...
// Desc: 
//-----------------------------------------------------------------------------
struct NVDX9SDKSampleFramework_API RenderUnit
{
    UINT                  iAdapter;
    UINT                  iMonitor;
    D3DDEVTYPE            DeviceType;      // Reference, HAL, etc.
...
//-----------------------------------------------------------------------------
class NVDX9SDKSampleFramework_API CD3DScreensaver
{
public:
                    CD3DScreensaver();
