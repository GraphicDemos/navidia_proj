...
//
// Author: Frank Jargstorff (10/2504)
//
// Note:
                ...
                , _pData(0)
{
    ; // empty
        ...
        //
Image::Image(unsigned int nWidth, unsigned int nHeight, tePixelFormat ePixelFormat, const void * pData)
                : _nWidth(nWidth)
                , _nHeight(nHeight)
...
Image::operator = (const Image & rImage)
{
    ...
    return *this;
        ...
        //
        void
Image::setData(unsigned int nWidth, unsigned int nHeight, tePixelFormat ePixelFormat, const void * pData)
{
        ...
        const
{
    ...
    //
        ...
        //
       unsigned int
Image::PixelDataSize(tePixelFormat ePixelFormat)
{
    switch (ePixelFormat)
    {
        case FP16_RGB_PIXEL:
    ...
    return 0;
        ...
        //
        Image
Image::ConvertPixelFormat(tePixelFormat ePixelFormat, const Image & rImage)
{
...
Image::HalfToByte(half nValue)
{
    ...
    return static_cast<unsigned char>(nInteger);
        ...
        inline
        half
Image::ByteToHalf(unsigned char nValue)
{
    return half(nValue * 255.0f);
}

       Image
Image::FP16_RGB_to_FP16_RGBA(const Image & rImage)
{
    ...
    return Image(rImage.width(), rImage.height(), FP16_RGBA_PIXEL, pNewData.get());
}

        Image
Image::FP16_RGBA_to_FP16_RGB(const Image & rImage)
{
    ...
    return Image(rImage.width(), rImage.height(), FP16_RGB_PIXEL, pNewData.get());
}

        Image
Image::FP16_RGBA_to_FX8_RGB(const Image & rImage)
{
    assert(rImage._ePixelFormat == FP16_RGBA_PIXEL);
    ...
    return Image(rImage.width(), rImage.height(), FX8_RGB_PIXEL, pNewData.get());
}

        Image
Image::FP16_RGBA_to_FX8_RGBA(const Image & rImage)
{
    assert(rImage._ePixelFormat == FP16_RGBA_PIXEL);
    ...
    return Image(rImage.width(), rImage.height(), FX8_RGBA_PIXEL, pNewData.get());
}

        Image
Image::FP16_RGBA_to_FX8_BGR(const Image & rImage)
{
    assert(rImage._ePixelFormat == FP16_RGBA_PIXEL);
    ...
    return Image(rImage.width(), rImage.height(), FX8_BGR_PIXEL, pNewData.get());
}

        Image
Image::FP16_RGBA_to_FX8_BGRA(const Image & rImage)
{
    assert(rImage._ePixelFormat == FP16_RGBA_PIXEL);
    ...
    return Image(rImage.width(), rImage.height(), FX8_BGRA_PIXEL, pNewData.get());
}

        Image
Image::FX8_RGB_to_FP16_RGBA(const Image & rImage)
{
    ...
    return Image(rImage.width(), rImage.height(), FP16_RGBA_PIXEL, pNewData.get());
        ...
        Image
Image::FX8_RGBA_to_FP16_RGBA(const Image & rImage)
{
    ...
    return Image();
        ...
        Image
Image::FX8_BGR_to_FP16_RGBA(const Image & rImage)
{
    ...
    return Image();
        ...
        Image
Image::FX8_BGRA_to_FP16_RGBA(const Image & rImage)
{
