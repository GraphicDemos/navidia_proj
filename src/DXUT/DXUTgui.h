...
struct NV_DXUT_API DXUTBlendColor
{
...
//-----------------------------------------------------------------------------
class NV_DXUT_API CDXUTElement
{
public:
...
//--------------------------------------------------------------------------------------
struct NV_DXUT_API DXUTTextureNode
{
...
struct NV_DXUT_API DXUTFontNode
{
...
//-----------------------------------------------------------------------------
class NV_DXUT_API CDXUTDialogResourceManager
{
public:
...
//-----------------------------------------------------------------------------
class NV_DXUT_API CDXUTControl
{
public:
...
//-----------------------------------------------------------------------------
struct NV_DXUT_API DXUTElementHolder
{
    UINT nControlType;
    UINT iElement;
...
// Static control
//-----------------------------------------------------------------------------
class NV_DXUT_API CDXUTStatic : public CDXUTControl
{
public:
...
// Button control
//-----------------------------------------------------------------------------
class NV_DXUT_API CDXUTButton : public CDXUTStatic
{
public:
...
// CheckBox control
//-----------------------------------------------------------------------------
class NV_DXUT_API CDXUTCheckBox : public CDXUTButton
{
public:
...
// RadioButton control
//-----------------------------------------------------------------------------
class NV_DXUT_API CDXUTRadioButton : public CDXUTCheckBox
{
public:
...
// Scrollbar control
//-----------------------------------------------------------------------------
class NV_DXUT_API CDXUTScrollBar : public CDXUTControl
{
public:
...
// ListBox control
//-----------------------------------------------------------------------------
struct NV_DXUT_API DXUTListBoxItem
{
    WCHAR strText[256];
    void* pData;
...
class NV_DXUT_API CDXUTListBox : public CDXUTControl
{
public:
...
// ComboBox control
//-----------------------------------------------------------------------------
struct NV_DXUT_API DXUTComboBoxItem
{
    WCHAR strText[256];
    void* pData;
...
class NV_DXUT_API CDXUTComboBox : public CDXUTButton
{
public:
...
// Slider control
//-----------------------------------------------------------------------------
class NV_DXUT_API CDXUTSlider : public CDXUTControl
{
public:
...
// EditBox control
//-----------------------------------------------------------------------------
class NV_DXUT_API CDXUTEditBox : public CDXUTControl
{
public:
