...
HRESULT GetFileDurationString(IMediaSeeking *pMS, TCHAR *szDuration)
{
...
#ifdef COMPILE_FOR_VS2005
    wcscpy_s(szDuration, _countof(TEXT("<00:00.000>\0")), TEXT("<00:00.000>\0"));
#else
    ...
    // Update the string
#ifdef COMPILE_FOR_VS2005
	swprintf_s(szDuration, 100, _T("%02dm:%02d.%03ds\0"), nMinutes, nSeconds, nMS);
#else
