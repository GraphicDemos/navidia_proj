...
class AM_NOVTABLE DIRECT_SHOW_BASE_CLASS_CLASS  CBaseMediaFilter : public CUnknown,
                                     public IMediaFilter
{
...
class DIRECT_SHOW_BASE_CLASS_CLASS AM_NOVTABLE CBaseFilter : public CUnknown,        // Handles an IUnknown
