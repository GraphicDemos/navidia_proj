...
half edgeDetectPS(in sampler2DRect ColorMap,
				   in half2 texcoords)
{
...
half edgeDetectPS2(in sampler2DRect ColorMap, in half T2)
{
	half4 CC;
...
void main()
{
//	gl_FragColor = edgeDetectPS(tex0, gl_TexCoord[0].xy).xxxx;
	gl_FragColor = edgeDetectPS2(tex0, Threshold*Threshold).xxxx;
//	gl_FragColor = edgeDetectColorPS(tex0, Threshold*Threshold).xxxx;
