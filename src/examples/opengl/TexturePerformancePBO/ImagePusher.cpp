...
const char * ImagePusher::ClassDescription = "Normal (glTexSubimage)";
    ...
    //
        ...
        // Default constructor
        //
ImagePusher::ImagePusher(): _hTexture(0)
                          , _nPixelFormatGL(0)
                          , _nFrameCounter(0)
{
...
ImagePusher::~ImagePusher()
{
    ...
    //
        ...
        //
        void
ImagePusher::setImage(const Image & rImage)
{
...
ImagePusher::imprintPixelData(void * pData, unsigned int nImprint)
{
    ...
    {
        case Image::FP16_RGB_PIXEL:
        case Image::FP16_RGBA_PIXEL:
            imprintHalfPixelData(static_cast<half *>(pData), nImprint);
        break;
        case Image::FX8_BGR_PIXEL:
        case Image::FX8_BGRA_PIXEL:
        case Image::FX8_RGB_PIXEL:
        case Image::FX8_RGBA_PIXEL:
