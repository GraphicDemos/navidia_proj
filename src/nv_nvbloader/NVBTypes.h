...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Include Guard
#ifndef __NVBTYPES_H__
#define __NVBTYPES_H__
...
#define NVB_COMPILE_TIME_ASSERT(name, x)    typedef int NVB_Dummy_ ## name[(x) * 2 - 1]

    NVB_COMPILE_TIME_ASSERT(ubyte,  sizeof(ubyte)==1);
    NVB_COMPILE_TIME_ASSERT(sbyte,  sizeof(sbyte)==1);
    NVB_COMPILE_TIME_ASSERT(sword,  sizeof(sword)==2);
    NVB_COMPILE_TIME_ASSERT(uword,  sizeof(uword)==2);
    NVB_COMPILE_TIME_ASSERT(udword, sizeof(udword)==4);
    NVB_COMPILE_TIME_ASSERT(sdword, sizeof(sdword)==4);
    NVB_COMPILE_TIME_ASSERT(uqword, sizeof(uqword)==8);
    NVB_COMPILE_TIME_ASSERT(sqword, sizeof(sqword)==8);

#undef NVB_COMPILE_TIME_ASSERT
...
#endif
    typedef bool                (*ENUMERATION)(udword value, udword param, udword context); //!< NVB standard enumeration call
